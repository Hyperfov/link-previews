...
function add_css$1(target) {
	append_styles(target, "svelte-x45ve5", ".preview.svelte-x45ve5{z-index:1000;position:absolute}.link.svelte-x45ve5{max-width:100%;text-decoration:none;padding:10px;margin-top:5px;font-weight:normal;font-style:normal}.preview-wrapper.svelte-x45ve5{position:absolute}");
}
...
function create_if_block$1(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "link svelte-x45ve5");
			add_render_callback(() => /*div0_elementresize_handler*/ ctx[15].call(div0));
			attr(div1, "class", "preview svelte-x45ve5");
			set_style(div1, "top", /*top*/ ctx[3] + "px");
			set_style(div1, "left", /*left*/ ctx[4] + "px");
			set_style(div1, "height", /*height*/ ctx[6] + "px");
			set_style(div1, "width", /*width*/ ctx[7] + "px");
		},
		m(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			attr(span, "class", "preview-wrapper svelte-x45ve5");
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(span, "mouseover", /*toggleOn*/ ctx[8]),
					listen(span, "focus", /*toggleOn*/ ctx[8]),
					listen(span, "mouseout", /*toggleOff*/ ctx[9]),
					listen(span, "blur", /*toggleOff*/ ctx[9])
				];
...
function instance$2($$self, $$props, $$invalidate) {
	...
	const positionPreview = actualHeight => {
		if (element) {
			...
			if (windowWidth - linkPos.x < fullWidth) {
				$$invalidate(4, left = windowWidth - fullWidth);
			} else {
				$$invalidate(4, left = linkPos.x);
			}

			if (windowHeight - (linkPos.y + linkPos.height) < fullHeight) {
				$$invalidate(3, top = linkPos.y - actualHeight - linkPos.height + 5);
			} else {
				$$invalidate(3, top = linkPos.y + linkPos.height);
			}
		}
	};
	...
	function div0_elementresize_handler() {
		...
		$$invalidate(1, renderedHeight);
	}

	$$self.$$set = $$props => {
		if ('showContent' in $$props) $$invalidate(10, showContent = $$props.showContent);
		if ('showImg' in $$props) $$invalidate(11, showImg = $$props.showImg);
		if ('position' in $$props) $$invalidate(0, position = $$props.position);
		if ('$$scope' in $$props) $$invalidate(12, $$scope = $$props.$$scope);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*renderedHeight*/ 2) {
			{
...
function add_css(target) {
	append_styles(target, "svelte-rhnvin", ".link-content.svelte-rhnvin{font-size:16px;line-height:110%;display:inline-block;position:relative;height:120px;overflow:hidden}.link-title.svelte-rhnvin{font-weight:bold}.link-content-wrapper.svelte-rhnvin{display:flex;border-bottom:1px solid var(--color);margin-bottom:5px}.link-image.svelte-rhnvin{height:120px;object-fit:cover;object-position:center center;width:100%;min-width:150px}.link-image.left.svelte-rhnvin{padding-left:10px}.hyperfov-link-url.svelte-rhnvin{font-size:12px}.link-content.svelte-rhnvin::after{content:\"\";position:absolute;bottom:0;left:0;width:275px;height:50px;background-image:linear-gradient(transparent, white)}");
}
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "link-content-wrapper svelte-rhnvin");
		},
		m(target, anchor) {
...
function create_if_block_3(ctx) {
	...
	return {
		c() {
			div = element("div");
			attr(div, "class", "link-content svelte-rhnvin");
		},
		m(target, anchor) {
			insert(target, div, anchor);
...
function create_if_block_2(ctx) {
	...
	return {
		c() {
			img = element("img");
			attr(img, "class", "link-image svelte-rhnvin");
...
function create_if_block(ctx) {
	...
	return {
		c() {
			div = element("div");
			t = text(/*title*/ ctx[4]);
			attr(div, "class", "link-title svelte-rhnvin");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, t);
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			div = element("div");
			t2 = text(/*href*/ ctx[5]);
			attr(div, "class", "hyperfov-link-url svelte-rhnvin");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [position, href, content, title, showContent, showImg];
}
