...
function add_css$1(target) {
	append_styles(target, "svelte-jns32b", ".preview.svelte-jns32b{z-index:1000;position:absolute;transition:opacity 0.5s;visibility:hidden;opacity:0}.preview.visible.svelte-jns32b{opacity:1;visibility:visible}.hyperfov-preview-element-wrapper.svelte-jns32b{font-family:sans-serif;color:black;max-width:100%;text-decoration:none;padding:10px;margin-top:5px;font-weight:normal;font-style:normal;border:1px solid black}.preview-wrapper.svelte-jns32b{position:absolute}");
}
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			attr(span, "class", "preview-wrapper svelte-jns32b");
			...
			attr(div0, "class", "hyperfov-preview-element-wrapper svelte-jns32b");
			add_render_callback(() => /*div0_elementresize_handler*/ ctx[16].call(div0));
			attr(div1, "class", "preview svelte-jns32b");
			...
			toggle_class(div1, "visible", /*visible*/ ctx[3]);
		},
		m(target, anchor) {
...
function add_css(target) {
	append_styles(target, "svelte-175w58j", ".hyperfov-link-title.svelte-175w58j{font-weight:bold}.hyperfov-link-content-wrapper.svelte-175w58j{display:flex;border-bottom:1px solid black;margin-bottom:5px}.hyperfov-link-image.svelte-175w58j{height:120px;object-fit:cover;object-position:center center;width:100%;min-width:150px}.hyperfov-link-image.left.svelte-175w58j{padding-left:10px}.hyperfov-link-url.svelte-175w58j{font-size:12px;color:black}.hyperfov-link-content.svelte-175w58j{font-size:12px;display:inline-block;position:relative;height:120px;overflow:hidden;background-color:white}.hyperfov-link-content.svelte-175w58j::after{content:\"\";position:absolute;bottom:0;left:0;width:275px;height:50px;background-image:linear-gradient(transparent, white)}.hyperfov-loading.svelte-175w58j{width:5px;height:5px;background-color:black;border-radius:50%;animation:svelte-175w58j-fade 1s ease infinite;margin-bottom:2px;display:inline-block}@keyframes svelte-175w58j-fade{from{opacity:1}to{opacity:0.1}}");
}
...
function create_if_block_2(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "hyperfov-link-content-wrapper svelte-175w58j");
		},
		m(target, anchor) {
...
function create_if_block_4(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "hyperfov-link-content svelte-175w58j");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, t);
...
function create_if_block_3(ctx) {
	...
	return {
		c() {
			img = element("img");
			attr(img, "class", "hyperfov-link-image svelte-175w58j");
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			div = element("div");
			t = text(/*title*/ ctx[4]);
			attr(div, "class", "hyperfov-link-title svelte-175w58j");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, t);
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (!current || dirty & /*title*/ 16) set_data(t, /*title*/ ctx[4]);
		},
		i(local) {
			if (current) return;
...
function create_if_block(ctx) {
	...
	return {
		c() {
			span = element("span");
			attr(span, "class", "hyperfov-loading svelte-175w58j");
		},
		m(target, anchor) {
			insert(target, span, anchor);
			current = true;
...
function create_fragment$1(ctx) {
	...
	let if_block1 = /*title*/ ctx[4] && create_if_block_1(ctx);
	let if_block2 = /*fetching*/ ctx[6] && create_if_block();
	...
	return {
		c() {
			...
			t2 = space();
			t3 = text(/*href*/ ctx[5]);
			attr(div, "class", "hyperfov-link-url svelte-175w58j");
		},
		m(target, anchor) {
...
function create_default_slot(ctx) {
	...
	interior = new Interior({
			props: {
				showContent: /*showContent*/ ctx[7],
				showImg: /*showImg*/ ctx[6],
				content: /*content*/ ctx[3],
				title: /*title*/ ctx[5],
				href: /*href*/ ctx[1],
				imgSrc: /*imgSrc*/ ctx[4],
				fetching: /*fetching*/ ctx[8]
			}
		});
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*showContent*/ 128) interior_changes.showContent = /*showContent*/ ctx[7];
			if (dirty & /*showImg*/ 64) interior_changes.showImg = /*showImg*/ ctx[6];
			if (dirty & /*content*/ 8) interior_changes.content = /*content*/ ctx[3];
			if (dirty & /*title*/ 32) interior_changes.title = /*title*/ ctx[5];
			if (dirty & /*href*/ 2) interior_changes.href = /*href*/ ctx[1];
			if (dirty & /*imgSrc*/ 16) interior_changes.imgSrc = /*imgSrc*/ ctx[4];
			if (dirty & /*fetching*/ 256) interior_changes.fetching = /*fetching*/ ctx[8];
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*showContent*/ 128) wrapper_changes.showContent = /*showContent*/ ctx[7];
			if (dirty & /*showImg*/ 64) wrapper_changes.showImg = /*showImg*/ ctx[6];
			if (dirty & /*position*/ 1) wrapper_changes.position = /*position*/ ctx[0];
			if (dirty & /*id*/ 4) wrapper_changes.id = "" + (/*id*/ ctx[2] + "-sub");

			if (dirty & /*$$scope, showContent, showImg, content, title, href, imgSrc, fetching*/ 1530) {
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		$$invalidate(9, worker = abab.atob(worker));
		...
		if (res.ok) {
			...
			$$invalidate(5, title = json.title);
			$$invalidate(4, imgSrc = json.image);
		}

		$$invalidate(8, fetching = false);
	});
	...
	$$self.$$set = $$props => {
		...
		if ('worker' in $$props) $$invalidate(9, worker = $$props.worker);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*content, imgSrc*/ 24) {
			{
				$$invalidate(7, showContent = content && content !== "null");
				$$invalidate(6, showImg = imgSrc && imgSrc !== "null");
			}
		}
	};
...
class LinkPreview_wc extends SvelteElement {
	constructor(options) {
		...
		init(
			...
			create_fragment,
			safe_not_equal,
			{ position: 0, href: 1, id: 2, worker: 9 },
			null
		);
	...
	static get observedAttributes() {
		return ["position", "href", "id", "worker"];
	}
...
window.setPagePreviews = function (options = {}) {
  ...
  for (const a of pageATags) {
    ...
    a.innerHTML += `<link-preview id="${shadowId}" position="${abab.btoa(
      JSON.stringify(aPos)
    )}" worker=${abab.btoa(options.workerUrl)} href="${a.href}"></link-preview>`;
...
export { Interior, LinkPreview_wc as LinkPreview, Wrapper };
