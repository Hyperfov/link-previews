...
function add_css$1(target) {
	append_styles(target, "svelte-h1vign", ".preview.svelte-h1vign{z-index:1000;position:absolute}.hyperfov-preview-element-wrapper.svelte-h1vign{font-family:sans-serif;color:black;max-width:100%;text-decoration:none;padding:10px;margin-top:5px;font-weight:normal;font-style:normal;border:1px solid black}.preview-wrapper.svelte-h1vign{position:absolute}");
}
...
function create_if_block$1(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "hyperfov-preview-element-wrapper svelte-h1vign");
			add_render_callback(() => /*div0_elementresize_handler*/ ctx[16].call(div0));
			attr(div1, "class", "preview svelte-h1vign");
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			attr(span, "class", "preview-wrapper svelte-h1vign");
...
function add_css(target) {
	append_styles(target, "svelte-jdych2", ".hyperfov-link-title.svelte-jdych2{font-weight:bold}.hyperfov-link-content-wrapper.svelte-jdych2{display:flex;border-bottom:1px solid black;margin-bottom:5px}.hyperfov-link-image.svelte-jdych2{height:120px;object-fit:cover;object-position:center center;width:100%;min-width:150px}.hyperfov-link-image.left.svelte-jdych2{padding-left:10px}.hyperfov-link-url.svelte-jdych2{font-size:12px;color:black}.hyperfov-link-content.svelte-jdych2{font-size:12px;display:inline-block;position:relative;height:120px;overflow:hidden;background-color:white}.hyperfov-link-content.svelte-jdych2::after{content:\"\";position:absolute;bottom:0;left:0;width:275px;height:50px;background-image:linear-gradient(transparent, white)}");
}
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "hyperfov-link-content-wrapper svelte-jdych2");
		},
		m(target, anchor) {
...
function create_if_block_3(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "hyperfov-link-content svelte-jdych2");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, t);
...
function create_if_block_2(ctx) {
	...
	return {
		c() {
			img = element("img");
			attr(img, "class", "hyperfov-link-image svelte-jdych2");
...
function create_if_block(ctx) {
	...
	return {
		c() {
			div = element("div");
			t = text(/*title*/ ctx[4]);
			attr(div, "class", "hyperfov-link-title svelte-jdych2");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, t);
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			div = element("div");
			t2 = text(/*href*/ ctx[5]);
			attr(div, "class", "link-url hyperfov-link-url svelte-jdych2");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, showContent, showImg, content, title, href, imgSrc*/ 762) {
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		$$invalidate(8, worker = abab.atob(worker));
	...
	$$self.$$set = $$props => {
		...
		if ('worker' in $$props) $$invalidate(8, worker = $$props.worker);
	};
	...
	return [position, href, id, content, imgSrc, title, showImg, showContent, worker];
}
...
class LinkPreview_wc extends SvelteElement {
	constructor(options) {
		...
		init(
			...
			create_fragment,
			safe_not_equal,
			{ position: 0, href: 1, id: 2, worker: 8 },
			null
		);
