...
function add_css$1(target) {
	append_styles(target, "svelte-y96cd", ".preview.svelte-y96cd{z-index:1000;position:absolute;transition:opacity 0.5s;visibility:hidden;opacity:0}.preview.visible.svelte-y96cd{opacity:1;visibility:visible}.hyperfov-preview-element-wrapper.svelte-y96cd{font-family:sans-serif;color:black;max-width:100%;text-decoration:none;padding:10px;margin-top:5px;font-weight:normal;font-style:normal;border:1px solid black;background-color:white}.preview-wrapper.svelte-y96cd{position:absolute}");
}
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			attr(span, "class", "preview-wrapper svelte-y96cd");
			...
			attr(div0, "class", "hyperfov-preview-element-wrapper svelte-y96cd");
			add_render_callback(() => /*div0_elementresize_handler*/ ctx[18].call(div0));
			attr(div1, "class", "preview svelte-y96cd");
...
function add_css(target) {
	append_styles(target, "svelte-1smurcm", ".hyperfov-link-title.svelte-1smurcm{font-weight:bold}.hyperfov-link-content-wrapper.svelte-1smurcm{display:flex;border-bottom:1px solid black;margin-bottom:5px}.hyperfov-link-image.svelte-1smurcm{height:120px;object-fit:cover;object-position:center center;width:100%;min-width:150px}.hyperfov-link-image.left.svelte-1smurcm{padding-left:10px}.hyperfov-link-url.svelte-1smurcm{font-size:12px;color:black}.hyperfov-link-content.svelte-1smurcm{font-size:14px;display:inline-block;position:relative;height:120px;overflow:hidden;background-color:white}.hyperfov-link-content.svelte-1smurcm::after{content:\"\";position:absolute;bottom:0;left:0;width:275px;height:50px;background-image:linear-gradient(#ffffff00, #ffffff)}.hyperfov-loading.svelte-1smurcm{width:5px;height:5px;background-color:black;border-radius:50%;animation:svelte-1smurcm-fade 1s ease infinite;margin-bottom:2px;display:inline-block}@keyframes svelte-1smurcm-fade{from{opacity:1}to{opacity:0.1}}");
}
...
function create_if_block_2(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "hyperfov-link-content-wrapper svelte-1smurcm");
		},
		m(target, anchor) {
...
function create_if_block_4(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "hyperfov-link-content svelte-1smurcm");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, t);
...
function create_if_block_3(ctx) {
	...
	return {
		c() {
			img = element("img");
			attr(img, "class", "hyperfov-link-image svelte-1smurcm");
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			div = element("div");
			t = text(/*title*/ ctx[4]);
			attr(div, "class", "hyperfov-link-title svelte-1smurcm");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, t);
...
function create_if_block(ctx) {
	...
	return {
		c() {
			span = element("span");
			attr(span, "class", "hyperfov-loading svelte-1smurcm");
		},
		m(target, anchor) {
			insert(target, span, anchor);
			current = true;
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			t2 = space();
			t3 = text(/*href*/ ctx[5]);
			attr(div, "class", "hyperfov-link-url svelte-1smurcm");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, showContent, showImg, content, title, href, imgSrc, fetching*/ 4601) {
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		$$invalidate(10, worker = abab.atob(worker));
	...
	$$self.$$set = $$props => {
		if ('eltpos' in $$props) $$invalidate(11, eltpos = $$props.eltpos);
		if ('href' in $$props) $$invalidate(0, href = $$props.href);
		if ('id' in $$props) $$invalidate(1, id = $$props.id);
		if ('worker' in $$props) $$invalidate(10, worker = $$props.worker);
		if ('position' in $$props) $$invalidate(2, position = $$props.position);
	};
...
class LinkPreview_wc extends SvelteElement {
	...
	static get observedAttributes() {
		return ["eltpos", "href", "id", "worker", "position"];
	}
