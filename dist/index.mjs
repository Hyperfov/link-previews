...
function add_css$1(target) {
	append_styles(target, "svelte-558qj6", ".preview.svelte-558qj6{z-index:1000;position:absolute}.link.svelte-558qj6{max-width:100%;text-decoration:none;padding:10px;margin-top:5px;font-weight:normal;font-style:normal}");
}

const get_preview_content_slot_changes = dirty => ({});
const get_preview_content_slot_context = ctx => ({});
...
function create_if_block$1(ctx) {
	...
	let div1_transition;
	let current;
	const preview_content_slot_template = /*#slots*/ ctx[14]["preview-content"];
	const preview_content_slot = create_slot(preview_content_slot_template, ctx, /*$$scope*/ ctx[13], get_preview_content_slot_context);

	return {
		c() {
			div1 = element("div");
			div0 = element("div");
			if (preview_content_slot) preview_content_slot.c();
			attr(div0, "class", "link svelte-558qj6");
			add_render_callback(() => /*div0_elementresize_handler*/ ctx[16].call(div0));
			attr(div1, "class", "preview svelte-558qj6");
		...
		m(target, anchor) {
			...
			if (preview_content_slot) {
				preview_content_slot.m(div0, null);
			}
		...
		p(new_ctx, dirty) {
			...
			if (preview_content_slot) {
				if (preview_content_slot.p && (!current || dirty & /*$$scope*/ 8192)) {
					update_slot_base(
						preview_content_slot,
						preview_content_slot_template,
						ctx,
						/*$$scope*/ ctx[13],
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[13])
						: get_slot_changes(preview_content_slot_template, /*$$scope*/ ctx[13], dirty, get_preview_content_slot_changes),
						get_preview_content_slot_context
					);
				}
			}
		...
		i(local) {
			if (current) return;
			transition_in(preview_content_slot, local);
		...
		o(local) {
			transition_out(preview_content_slot, local);
		...
		d(detaching) {
			...
			if (preview_content_slot) preview_content_slot.d(detaching);
...
function create_fragment$2(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(span0, "mouseover", /*toggleOn*/ ctx[9]),
					listen(span0, "focus", /*toggleOn*/ ctx[9]),
					listen(span0, "mouseout", /*toggleOff*/ ctx[10]),
					listen(span0, "blur", /*toggleOff*/ ctx[10])
				];
		...
		p(ctx, [dirty]) {
			if (!current || dirty & /*linkcontent*/ 1) set_data(t0, /*linkcontent*/ ctx[0]);
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('linkcontent' in $$props) $$invalidate(0, linkcontent = $$props.linkcontent);
...
function add_css(target) {
	append_styles(target, "svelte-v7zpmj", ".link-content.svelte-v7zpmj{font-size:16px;line-height:110%;display:inline-block;position:relative;height:120px;overflow:hidden}.link-title.svelte-v7zpmj{font-weight:bold}.link-content-wrapper.svelte-v7zpmj{display:flex;border-bottom:1px solid var(--color);margin-bottom:5px}.link-image.svelte-v7zpmj{height:120px;object-fit:cover;object-position:center center;width:100%;min-width:150px}.link-image.left.svelte-v7zpmj{padding-left:10px}.link-url.svelte-v7zpmj{font-size:12px}.link-content.svelte-v7zpmj::after{content:\"\";position:absolute;bottom:0;left:0;width:275px;height:50px;background-image:linear-gradient(transparent, white)}");
}
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "link-content-wrapper svelte-v7zpmj");
		},
		m(target, anchor) {
...
function create_if_block_3(ctx) {
	...
	return {
		c() {
			div = element("div");
			attr(div, "class", "link-content svelte-v7zpmj");
		},
		m(target, anchor) {
			insert(target, div, anchor);
...
function create_if_block_2(ctx) {
	...
	return {
		c() {
			img = element("img");
			attr(img, "class", "link-image svelte-v7zpmj");
...
function create_if_block(ctx) {
	...
	return {
		c() {
			div = element("div");
			t = text(/*title*/ ctx[4]);
			attr(div, "class", "link-title svelte-v7zpmj");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, t);
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			div = element("div");
			t2 = text(/*href*/ ctx[5]);
			attr(div, "class", "link-url svelte-v7zpmj");
		},
		m(target, anchor) {
...
function create_preview_content_slot(ctx) {
	let interior;
	let current;
	...
	interior = new Interior({
			props: {
				...
				showContent: /*showContent*/ ctx[4],
				showImg: /*showImg*/ ctx[5],
...
function create_fragment(ctx) {
	...
	wrapper = new Wrapper({
			props: {
				...
				showContent: /*showContent*/ ctx[4],
				showImg: /*showImg*/ ctx[5],
				linkcontent: /*linkcontent*/ ctx[0],
				$$slots: {
					"preview-content": [create_preview_content_slot]
				},
				$$scope: { ctx }
			}
		});
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*linkcontent*/ 1) wrapper_changes.linkcontent = /*linkcontent*/ ctx[0];
...
function instance($$self, $$props, $$invalidate) {
	...
	let { href } = $$props;
	let { styles } = $$props;
	styles = JSON.parse(abab.atob(styles));
	let content;
	let title;
	let imgSrc;
	...
	return [linkcontent, href, content, title, showContent, showImg, styles];
}
...
class LinkPreview_wc extends SvelteElement {
	...
	static get observedAttributes() {
		return ["linkcontent", "href", "styles"];
	}
...
window.setPagePreviews = function (styles = defaultStyles) {
  ...
  for (const a of pageATags) {
    ...
    a.outerHTML = `<link-preview styles=${abab.btoa(
