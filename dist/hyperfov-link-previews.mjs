...
function add_css$1(target) {
	append_styles(target, "svelte-v3u9b1", ".preview.svelte-v3u9b1{z-index:1000;position:absolute;transition:opacity 0.5s;visibility:hidden;opacity:0}.preview.visible.svelte-v3u9b1{opacity:1;visibility:visible}.hyperfov-preview-element-wrapper.svelte-v3u9b1{font-family:sans-serif;color:black;max-width:100%;text-decoration:none;padding:10px;margin-top:5px;font-weight:normal;font-style:normal;font-size:14px;border:1px solid black;background-color:white}");
}
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "hyperfov-preview-element-wrapper svelte-v3u9b1");
			attr(div1, "class", "preview svelte-v3u9b1");
			set_style(div1, "top", /*top*/ ctx[2] + "px");
			set_style(div1, "left", /*left*/ ctx[3] + "px");
...
function instance$2($$self, $$props, $$invalidate) {
	...
	const positionPreview = () => {
		...
		if (eltPos) {
			...
			if (windowWidth - eltPos.x < fullWidth) {
				$$invalidate(3, left = windowWidth - fullWidth + window.scrollX);
			} else {
	...
	$$self.$$set = $$props => {
		if ('showContent' in $$props) $$invalidate(6, showContent = $$props.showContent);
...
const utf8ToB64 = (utf8) => {
  ...
  return abab.btoa(converted);
};

const b64ToUtf8 = (b64) => {
  const decoded = abab.atob(b64);
